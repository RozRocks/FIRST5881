...
std::shared_ptr<AnalogAccelerometer> RobotMap::driveControlAnalogAccelerometer1WRONG;
...
void RobotMap::init() {
    ...
    driveControlAnalogAccelerometer1WRONG.reset(new AnalogAccelerometer(0));
    lw->AddSensor("Drive Control", "AnalogAccelerometer 1 WRONG", driveControlAnalogAccelerometer1WRONG);
    driveControlAnalogAccelerometer1WRONG->SetSensitivity(0.0);
        driveControlAnalogAccelerometer1WRONG->SetZero(2.5);
