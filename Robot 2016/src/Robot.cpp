...
std::shared_ptr<DriveControl> Robot::driveControl;
...
void Robot::RobotInit() {
    ...
    arm.reset(new Arm());
    driveControl.reset(new DriveControl());
	...
	autonomousCommand.reset(new AutonomousCommand("reach"));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS

	driveCommand.reset(new Drive(10));

	autoChooser.reset(new SendableChooser());
	autoChooser->AddDefault("Reach Defense", autonomousCommand.get());
	...
	SmartDashboard::PutData("Autonomous Mode Selection", autoChooser.get());
  }
...
void Robot::TeleopInit() {
	...
	if (driveCommand.get() != nullptr)
		driveCommand.get()->Start();
}
