...
private:
	...
	std::shared_ptr<SendableChooser> autoSpeedChooser;
...
public:
	...
	double getFullPowerTime();
	double getHalfPowerTime();
	double getThirdPowerTime();
	double getAutoGyroTolerance();
	std::string getAutoSpeedSelection();
	float getAutoSpeedValue();
	double getAutoSetPowerTime();
};
