...
class DynamicCameraServer : public ErrorBase {
 private:
 ...
 public:
  static DynamicCameraServer* GetInstance();
  ...
  void SwitchAutomaticCapture(char const* cameraName);
