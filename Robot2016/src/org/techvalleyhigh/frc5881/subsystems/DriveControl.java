...
public class DriveControl extends Subsystem {
    ...
    private void initSmartDashboard() {
        ...
        SmartDashboard.putNumber(FULL_POWER_TIME, 0.92);
        SmartDashboard.putNumber(HALF_POWER_TIME, 1.84);
        SmartDashboard.putNumber(ONETHIRD_POWER_TIME, 2.76);
   ...
   public void rawDrive(float move, float turn) {
    ...
    /**
     * Returns the float value for the motor drive power for the set autonomous speed.
     * 
     * @return float for motor power at selected speed
     */
    public float getAutoSpeedValue() {
    	String speed = (String) autoSpeedChooser.getSelected();
